...
<div class="container mx-auto px-4 py-8">
    <div class="glass-effect rounded-lg p-6 max-w-2xl mx-auto relative">
        <div class="absolute top-4 right-4">
            <a href="editAdminInfo.php" class="btn-hover bg-green-800 text-white font-semibold py-2 px-4 rounded-full flex items-center gap-2 hover:bg-green-900 transition-all">
        ...
        <div class="flex flex-col items-center mb-6">
            ...
            <h2 class="text-2xl font-bold text-gray-800 text-shadow-md">Information</h2>
        </div>
        <div class="space-y-4">
